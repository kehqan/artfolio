          ...
          <section style={{ marginBottom: 52 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 14 }}>
              {artworks.map((a) => {
                ...
                return (
                  <Link key={a.id} href={`/profile/${params.username}/artwork/${a.id}`} style={{ textDecoration: "none", display: "block" }}>
                    <div
                      style={{ background: "#fff", border: "2px solid #111110", borderRadius: 8, overflow: "hidden", boxShadow: "3px 3px 0 #111110", cursor: "pointer" }}
              ...
              {collabs.map((c) => (
                <div key={c.id} style={{ background: "#fff", border: "2px solid #111110", borderRadius: 8, padding: "14px 16px", boxShadow: "3px 3px 0 #111110" }}>
                  <div style={{ display: "flex", alignItems: "flex-start", gap: 8, marginBottom: 8 }}>
                    ...
                    {c.type && <span style={{ fontSize: 9, fontWeight: 800, padding: "2px 7px", border: "1.5px solid #111110", borderRadius: 3, background: "#F5F0E8", color: "#5C5346", textTransform: "uppercase" }}>{c.type as string}</span>}
                  </div>

    ...
    <>
      <style>{`
        * { box-sizing: border-box; }
        ...
        .am-dashboard-btn.inactive:hover { background: #F5F0E8; }
                ...
                {searchOpen && (
                  <div className="am-search-panel">
                    ...
                    {searchResults.length > 0 ? (
                        ...
                        {searchResults.map(item => {
                          ...
                          return (
                            <Link key={item.href} href={item.href}
                              ...
                              style={{ display: "flex", alignItems: "center", gap: 10, padding: "10px 14px", textDecoration: "none", borderBottom: "1px solid #F5F0E8", transition: "background 0.1s" }}
                              onMouseEnter={e => (e.currentTarget.style.background = "#FFFBEA")}
                              onMouseLeave={e => (e.currentTarget.style.background = "transparent")}>
                              <IIcon size={14} color="#5C5346" />
                      ...
                      <div style={{ padding: "20px 16px", textAlign: "center", fontSize: 13, color: "#9B8F7A" }}>No pages found</div>
                    ) : null}
                  </div>
                )}
              </div>
            ...
            <div style={{ marginTop: 8, paddingTop: 12, borderTop: "1px solid #E0D8CA" }}>
              <Link href="/dashboard/artworks/new" style={{ textDecoration: "none" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, padding: "12px 16px", background: "#FFD400", borderRadius: 10, marginBottom: 8 }}>
                  ...
                  <span style={{ fontSize: 14, fontWeight: 800, color: "#111110" }}>+ Add a Work</span>
                </div>
              </Link>
              <button onClick={handleLogout}

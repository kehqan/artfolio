...
import { Search, UserCheck, UserPlus, MapPin } from "lucide-react";
    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="card p-16 text-center">
          <p className="text-stone-400">No artists found</p>
        </div>
      ) : (
            ...
            <div key={p.id} className="card-hover p-5 flex flex-col">
              <div className="flex items-start gap-3 mb-3">
                {p.avatar_url ? (
                  ...
                  <div className="w-12 h-12 rounded-full bg-stone-200 flex items-center justify-center text-stone-600 font-semibold text-lg shrink-0">
                    {p.full_name?.[0] || "A"}
                  </div>
                )}
